...
## 🗂 Workflow File
- `My workflow 5 (1).json` → Import this file into **n8n** to run the workflow.<img width="1685" height="890" alt="image" src="https://github.com/user-attachments/assets/d63c2fd5-3bf6-43a0-bdab-821d8e7ffb5f" />
